    ...
    const FAQText = [
      {
        ...
        answer: (
          <div>
            Ssam is a liquid staking solution for ETH 2.0 backed by industry-leading
            staking providers. Ssam lets users stake their ETH - without locking
      ...
      },
      {
        ...
        answer: (
          <div>
            When staking with Ssam, users receive smETH tokens on a 1:1 basis
            representing their staked ETH. smETH balances can be used like regular
            ...
            minimum deposits when staking with Ssam.
            <br />
            <br />
            When using Ssam, users receive secure staking rewards in real-time,
            ...
            Learn more{' '}
            <a
              href='https://blog.Ssam.fi/how-Ssam-works/'
              target='_blank'
              rel='noreferrer'
            >
              here
      ...
      },
      {
        ...
        answer: (
          <>
            smETH is a token that represents staked ether in Ssam, combining the
            value of initial deposit + staking rewards. smETH tokens are minted upon
            deposit and burned when redeemed. smETH token balances are pegged 1:1 to
            the ethers that are staked by Ssam. smETH token’s balances are updated
            when the oracle reports change in total stake every day.
            <br />
            <br />
            smETH tokens can be used as one would use ether, allowing you to earn
      ...
      },
      {
        ...
        answer: (
          <>
            LDO is an Ethereum token granting governance rights in the Ssam DAO. The
            Ssam DAO governs a set of liquid staking protocols, decides on key
            ...
            voting rights within the Ssam DAO. The more LDO locked in a user’s
      ...
      },
      {
        ...
        answer: (
          <div>
            ...
            Ssam you stake across many validators, minimising your staking risk.
          </div>
        ),
      },
      {
        ...
        answer: (
          <div>
            ...
            <br />
            <br />
            Through the use of a liquid self-staking service such as Ssam, users can
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                <p>
                  There is an inherent risk that Ssam could contain a smart contract
                  vulnerability or bug. The Ssam code is open-sourced, audited and
              ...
              <li>
                ...
                <p>
                  Ssam is built atop experimental technology under active
                  development, and there is no guarantee that ETH 2.0 has been
                  developed error-free. Any vulnerabilities inherent to ETH 2.0
                  brings with it slashing risk, as well as smETH fluctuation risk.
                </p>
              </li>
              <li>
                <strong>ETH 2.0 - Adoption risk</strong>
                <p>
                  The value of smETH is built around the staking rewards associated
                  ...
                  the value of ETH and smETH.
                </p>
              </li>
              <li>
                <strong>DAO key management risk</strong>
                <p>
                  Ether staked via the Ssam DAO is held across multiple accounts
              ...
              <li>
                ...
                <p>
                  ...
                  Ssam stakes across multiple professional and reputable node
                  operators with heterogeneous setups, with additional mitigation in
                  the form of insurance that is paid from Ssam fees.
                </p>
              </li>
              <li>
                <strong>smETH price risk</strong>
                <p>
                  Users risk an exchange price of smETH which is lower than inherent
                  value due to withdrawal restrictions on Ssam, making arbitrage and
                  risk-free market-making impossible. The Ssam DAO is driven to
